...
//#region node_modules/.nitro/vite/services/ssr/assets/router-lrZ2RYG6.js
...
function TooltipContent({ className, sideOffset = 6, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
		sideOffset,
		className: cn("z-50 max-w-xs rounded-md bg-surface-2 px-2.5 py-1.5 text-xs text-fg shadow-[var(--shadow-border)]", className),
		...props
	}) });
}
var styles_default = "/assets/styles-y-TnTeVQ.css";
var APP_NAME = "Sonara";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Sonara maps urban and wildlife noise from ESP32 and MagicBit listeners into a 24-hour acoustic heatmap."
			},
			{
				name: "theme-color",
				content: "#0b0d0c"
...
var $$splitComponentImporter$2 = () => import("./routes-YyzebUU2.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./lab-DNPVMqM1.mjs");
var Route$1 = createFileRoute("/lab")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./log-7oerqr5t.mjs");
var Route = createFileRoute("/log")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
